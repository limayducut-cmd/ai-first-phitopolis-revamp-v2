    ...
    <div className="bg-white min-h-screen text-primary">
      <section className="py-24 text-primary">
        <div className="container mx-auto px-6">
          ...
          {/* Google Map — full width within the section */}
          <motion.div
          ...
          >
            <iframe
              src="https://maps.google.com/maps?q=Ecotower+Building,32nd+Street,Bonifacio+Global+City,Taguig,Philippines&output=embed&z=16"
              width="100%"
              height="450"
              ...
              title="Phitopolis Office Location"
            />
          </motion.div>
        </div>
      </section>
